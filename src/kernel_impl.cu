...
std::string cuda_checks::CUDA_CHECK_VAL(cudaError_t);
std::string cuda_checks::CURAND_CHECK_VAL(curandStatus_t);
...
std::string cuda_checks::CUDA_CHECK_VAL(cudaError_t x)
{
    std::string msg;
...
std::string cuda_checks::CURAND_CHECK_VAL(curandStatus_t x)
{
    std::string msg;
