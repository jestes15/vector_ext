...
namespace test_quaternion
{
    ...
    private:
        ...
        void test_unit_vector_constructor()
        {
            ...
            quaternion expected_result = quaternion<int>(25, 1, 2, 3);
        ...
        {
            int arr[3] = {3, 4, 5};
            quaternion q = quaternion<int>(91, arr);
        ...
        {
            int arr[3] = {3, 4, 5};
            quaternion q = quaternion<int>(arr);
        ...
        void test_multiplication() {
            ...
            quaternion expected_result = quaternion(-60, 20, 14, 32);
            quaternion result = q1 * q2;
